...
scriptInjection("https://code.jquery.com/jquery-3.2.1.min.js", function () {
    ...
    else if (Shopify.shop == "654c1e-3.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
    else if (Shopify.shop == "chisportate.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
    else if (Shopify.shop == "54646b-3.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
    else if (Shopify.shop == "pet-haven-hub-1282.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
    else if (Shopify.shop == "tifmo-co.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
    else if (Shopify.shop == "golston-jewelry.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
    else if (Shopify.shop == "9b35c4.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
    else if (Shopify.shop == "sweetpeeps.myshopify.com") {
    var meta = { "product": { "id": __st.rid } };
    }
    else if (Shopify.shop == "3ce806-2.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
    ...
    else if (Shopify.shop == "sss-vault.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
    else if (Shopify.shop == "632c06.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
     else if (Shopify.shop == "3f8d1d-3.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
     else if (Shopify.shop == "75aa3b-3.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    }
    else{
        var meta = { "product": { "id": __st.rid } };
    ...
    */
    ...
    if (Shopify.shop == "b50db6-cc.myshopify.com") {
        customSelector = $jq321(".product-info__buy-buttons");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "ortho-confort.myshopify.com") {
        customSelector = $jq321(".btn--add-to-cart");
        finalSelector = customSelector[0];
    }
     if (Shopify.shop == "9baa3a-7b.myshopify.com") {
        customSelector = $jq321(".product-form__buttons");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "3474cb-8b.myshopify.com") {
        customSelector = $jq321(".price--large");
        finalSelector = customSelector[0];
        $jq321("head").append('<style type="text/css">.stock-top{width: 75% !important;}</style>');
    }
    if (Shopify.shop == "bb0bab-d2.myshopify.com") {
        customSelector = $jq321(".product-form__payment-container");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "c0ee03-09.myshopify.com") {
        customSelector = $jq321("#es-form-button");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "eb64a0-00.myshopify.com") {
    ...
    if (Shopify.shop == "9e9554-39.myshopify.com") {
        customSelector = $jq321(".product-info__block-item");
        finalSelector = customSelector[6];
    }
    if (Shopify.shop == "26e5c4-8a.myshopify.com") {
        $jq321("head").append('<style type="text/css">.cart-countdown-desktop-top-center{margin-bottom: 20px !important; margin-top: -38px !important;}</style>');
    }
    if (Shopify.shop == "748ad8-76.myshopify.com") {
        $jq321("head").append('<style type="text/css">.stock-progress-background{display: none !important;}</style>');
    }
    if (Shopify.shop == "a2ca98-3f.myshopify.com") {
        customSelector = $jq321("div.product-price-container");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "f8c392-2d.myshopify.com") {
        customSelector = $jq321(".swatch_options");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "7b2b6c-10.myshopify.com") {
        customSelector = $jq321(".product-single__price");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "origine-one.myshopify.com") {
        customSelector = $jq321(".product-page--submit-action");
        finalSelector = customSelector[0];
    }
    ...
    if (Shopify.shop == "75aa3b-3.myshopify.com") {
        customSelector = $jq321(".shopify-product-form");
        finalSelector = customSelector[1];
    }
    if (Shopify.shop == "bffe07-71.myshopify.com") {
        customSelector = $jq321(".ProductForm__Variants");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "59ece7-5.myshopify.com") {
        customSelector = $jq321("button.add-to-cart");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "3710a5-9f.myshopify.com") {
        customSelector = $jq321(".product-form__buttons");
        finalSelector = customSelector[0];
    }
     if (Shopify.shop == "ec32e5-9a.myshopify.com") {
        customSelector = $jq321(".product-single__price");
        finalSelector = customSelector[0];
     }
     if (Shopify.shop == "m-sou-store.myshopify.com") {
        customSelector = $jq321(".flex.wrap");
        finalSelector = customSelector[1];
    }
    if (Shopify.shop == "5f9b95-b3.myshopify.com") {
        customSelector = $jq321(".product-form--atc");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "e2da57-b9.myshopify.com") {
        customSelector = $jq321(".pf-31_");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "2fe139-6.myshopify.com") {
        customSelector = $jq321(".product__text");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "2c2480-2.myshopify.com") {
        customSelector = $jq321("#_rsi-buy-now-button-overwrite");
        finalSelector = customSelector[0];
        $jq321("head").append('<style type="text/css">.timer-store-front{margin-top: 14px; !important}</style>');
    }
    if (Shopify.shop == "50b650-21.myshopify.com") {
        customSelector = $jq321(".product-info__liquid");
        finalSelector = customSelector[0];
    }
    ...
    if (Shopify.shop == "faa1a1-4.myshopify.com") {
        customSelector = $jq321(".sc-gdyfxU");
        finalSelector = customSelector[0];
    }
    ...
    if (Shopify.shop == "saiid-merchandise.myshopify.com") {
        ...
        finalSelector = customSelector[0];
        $jq321("head").append('<style type="text/css">#shopify-section-product-template .stock-top .stock-message{display: block !important;}</style>');
    }
    if (Shopify.shop == "a9ed6a-2.myshopify.com") {
        customSelector = $jq321("#product-pack-form");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "e72381-2.myshopify.com") {
        customSelector = $jq321(".product-variant-inventory");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "830569.myshopify.com") {
        $jq321("head").append('<style type="text/css">.stock-top{margin-top: 14px; !important}</style>');
    ...
    if (Shopify.shop == "c1faaa-4.myshopify.com") {
        customSelector = $jq321(".prd-block-price");
        finalSelector = customSelector[0];
    }
   if (Shopify.shop == "f35603-3.myshopify.com") { 
        $jq321("head").append('<style type="text/css">.timer-store-front{margin-top: 14px; !important}</style>');
        customSelector = $jq321(".sc-hLVXRe");
        finalSelector = customSelector[0];
    }
    ...
    if (Shopify.shop == "095a87-2.myshopify.com") {
        $jq321("head").append('<style type="text/css">.stock-top{margin-top: 14px; !important}</style>');
        masterSelector = $jq321("#prvw__bottom_title");
    ...
    if (Shopify.shop == "cf8568.myshopify.com") {
   ...
   if (Shopify.shop == "ff3abc.myshopify.com") {
    ...
    if (Shopify.shop == "54646b-3.myshopify.com") {
        customSelector = $jq321(".product-form--atc-button");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "tifmo-co.myshopify.com") {
        customSelector = $jq321(".product__block__buttons");
        finalSelector = customSelector[0];
    }
    ...
    if (Shopify.shop == "golston-jewelry.myshopify.com") {
        customSelector = $jq321(".product-form__quantity-submit.pt-4");
        finalSelector = customSelector[0];
        console.log(finalSelector);
    }
    if (Shopify.shop == "9b35c4.myshopify.com") {
        customSelector = $jq321(".nt_lt_fake");
        finalSelector = customSelector[0];
        console.log(finalSelector);
    }
    ...
    if (Shopify.shop == "wisteria-chile.myshopify.com") {
    ...
    if (Shopify.shop == "0ad155.myshopify.com") {
        $jq321("head").append('<style type="text/css">#clockdivpreview{ flex-direction: row-reverse; display: flex; justify-content: center;}.colon{top: -1px !important;}</style>');
        customSelector = $jq321(".product-info__buy-buttons");
        finalSelector = customSelector[0];
    }
    ...
    if (Shopify.shop == "6bccd5.myshopify.com") {
        customSelector = $jq321("._rsi-buy-now-button");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "372369-3.myshopify.com") {
        customSelector = $jq321(".product-form__buttons");
        finalSelector = customSelector[0];
    }
    if (Shopify.shop == "3f8d1d-3.myshopify.com") {
        customSelector = $jq321(".unit-price");
        finalSelector = customSelector[0];
    }
    ...
    if (Shopify.shop == "f8c697.myshopify.com") {
        ...
        if (Shopify.shop == "262bc3-2.myshopify.com") {
            customSelector = $jq321(".sc-hlGDCY");
            finalSelector = customSelector[0];
            console.log(finalSelector);
        }
        ...
        if (barID.length == 0) {
            ...
            if (barStatus !== "nothing") {
                ...
                */
                ...
                if (Shopify.shop == "ortho-confort.myshopify.com") {
                    $jq321(document).ready(function () {
                        if (window.location.pathname === '/cart') {
                            $jq321("head").append('<style type="text/css">.cart-countdown-desktop-top-center{display: block !important;}</style>');
                        } else {
                            $jq321("head").append('<style type="text/css">.cart-countdown-desktop-top-center{display: none !important;}</style>');
                        }
                    });
                }
                if (Shopify.shop == "navvimate.myshopify.com") {
                    $jq321("head").append('<style type="text/css">.cart-countdown-desktop-top-center{margin-bottom:15px;}</style>');
                    firstSelector = $jq321(".cart-drawer__form");
                } else {
                    firstSelector = $jq321("form[action='/cart']").parent();
                }
                if (Shopify.shop == "64b082-3.myshopify.com") {
                    firstSelector = $jq321(".title-wrapper-with-link");
                } else {
                    firstSelector = $jq321("form[action='/cart']").parent();
                }
                ...
                if (Shopify.shop == "0ad155.myshopify.com") {
                    firstSelector = $jq321(".cart-header");
                } else {
                    firstSelector = $jq321("form[action='/cart']").parent();
                }
