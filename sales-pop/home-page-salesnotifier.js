 ...
 */
 ...
 console.log(cc_product_id);
  ...
  if (Shopify.shop == "506933-61.myshopify.com")
     {
        ...
        masterSelector = $jq321(".product__modal-opener");
        finalSelector = masterSelector[0];
        $jq321("head").append('<style type="text/css">.timer-store-front {margin-top: -81px !important; margin-bottom: 5px !important;} ' +
        '@media only screen and (max-width: 740px){margin-top: 0px !important;}</style>');
     }
     if (Shopify.shop == "829e61-2.myshopify.com")
     {
        productID = 8544393429322;
        masterSelector = $jq321(".banner");
        finalSelector = masterSelector[0];
        $jq321("head").append('<style type="text/css">.timer-store-front {margin-top: 14px !important;}</style>');
     }
     if (Shopify.shop == "2ab064-3.myshopify.com")
     {
        productID = 8810998956356;
     }
     ...
     if (Shopify.shop == "contactbusinespro.myshopify.com")
     {
        productID = 7673598181631;
  ...
  if (Shopify.shop == "paint-by-canvas.myshopify.com")
     ...
     if (Shopify.shop == "sleekluv.myshopify.com")
     {
        productID = 8211622297918;
  ...
  if (Shopify.shop == "c49396.myshopify.com") 
     {
        productID = 8508578595154;
     }
 ...
 // ******************************************************************************************
     function visitorCounter(response) 
     {
         ...
         if (Shopify.shop == "b0ad29.myshopify.com") 
         {
             if (window.location.href == 'https://ismartstore.shop/')
             {
                 return false;
             }
         }
