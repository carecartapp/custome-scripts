...
//****** Store Frontend JS - carecartSpinnerApp.js GH v.6.0.0 - Build ver 6.24 *******************
            ...
            scriptInjection(CDN_WHEELIFY_URL + "spinner.min.js", function () {
                ...
                function showSpinASaleModule(type = '') {
                   ...
                   /* if (Shopify.shop == 'divinederriere.myshopify.com') {
                    ...
                    if (Shopify.shop == 'yun-yun-sun.myshopify.com') {
                        var newValue = 'https://cdn.jsdelivr.net/gh/carecartapp/custome-scripts@v6.24/spinner/cara-3031-bg-circle.png';
                        carecartSpinnerJquery('.wheelLogo').attr("xlink:href", newValue);
                    }
               ...
               if (Shopify.shop == 'matreejewels.myshopify.com') {
                ...
                if (Shopify.shop == 'doublestitchbybedsure.myshopify.com') {
                    carecartSpinnerJquery('head').append('<style type="text/css">#wheelify-spin_a_sale_cc_store_front_module .checkbox{width: auto;height: auto; background-color: transparent; box-shadow: none;} #wheelify-spin_a_sale_cc_store_front_module .btn-submit-form, #wheelify-spin_a_sale_cc_store_front_module .btn-submit-form-ok, #wheelify-spin_a_sale_cc_store_front_module .copy-button{text-align:center;} .wheelify-signupContainer .checkbox input{margin-top:4px;}</style>');
                }
                if (Shopify.shop == 'bru-tea.myshopify.com') {
                    carecartSpinnerJquery('head').append('<style type="text/css">#wheelify-spin_a_sale_cc_store_front_module .checkbox{    background-color: transparent;width: auto;height: auto;box-shadow: none;}#wheelify-spin_a_sale_cc_store_front_module .btn-submit-form, #wheelify-spin_a_sale_cc_store_front_module .btn-submit-form-ok, #wheelify-spin_a_sale_cc_store_front_module .copy-button{text-align:center;}</style>');
                }
            });
