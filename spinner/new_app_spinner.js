    ...
    scriptInjection("https://code.jquery.com/jquery-3.2.1.min.js", function () {
        ...
        setTimeout(function () {
		   ...
		   if (Shopify.shop == 'flowyline-official.myshopify.com') {
			var newValue = 'https://cdn.jsdelivr.net/gh/carecartapp/custome-scripts@7.36/spinner/3263.png';
			carecartSpinnerJquery('.wheelLogo').attr("xlink:href", newValue);
		    }
		    ...
		    if (Shopify.shop == 'lilash-new-zealand.myshopify.com') {
                        var newValue = 'https://cdn.jsdelivr.net/gh/carecartapp/custome-scripts@6.78/spinner/logo.png';
                        carecartSpinnerJquery('.wheelLogo').attr("xlink:href", newValue);
                    }
                    /*Custom fix*/
        ...
        if (Shopify.shop == '063eb2-2.myshopify.com') {
            carecartSpinnerJquery('body').append("<style type='text/css'> #cc-spinner-full-name::placeholder { font-family: var(--font-body-family); } #cc-spinner-email::placeholder { font-family: var(--font-body-family); } #cc-spin-a-sale-consent-checkbox{margin-top: 4px;} @media only screen and (max-width: 768px){.wheelLogo { transform: none !important; }}</style>"); 
        }
        ...
        if (Shopify.shop == 'shop-gorman.myshopify.com') {
            		carecartSpinnerJquery('body').append("<style type='text/css'>#wheelify-spin_a_sale_cc_store_front_module .checkbox{display: block;background: transparent; border: none; width: auto; height: auto; box-shadow: none;} .btn-submit-form{text-align: center;} .wheelify-signupContainer .checkbox input {display: block; appearance: auto; width: 13px; height: 15px;}</style>");    
	    }
        ...
        if (Shopify.shop == 'greencornerss.myshopify.com') {
                    carecartSpinnerJquery('body').append("<style type='text/css'>#wheelify-spin_a_sale_cc_store_front_module .checkbox{background: transparent;border: none;width: auto;height: auto;box-shadow: none;} .btn-submit-form{text-align: center;} .wheelify-signupContainer .checkbox input{margin-top: 4px;} #wheelify-spin_a_sale_cc_store_front_module .wheelify-signupContainer{margin-top: 30px !important;} #wheelify-spin_a_sale_cc_store_front_module .wheelText { font-size: 20px !important; font-weight: 800; } </style>");       
            }
		...
		if (Shopify.shop == 'shopping-at-tiffanys.myshopify.com') {
                    carecartSpinnerJquery(document).on('click', '#spin_a_sale_cc_store_front_module_close_button, #wheelify-spin-trigger-cc', function(event) {
                        event.preventDefault();
                    });
                }
		...
		if (Shopify.shop == '478b62-19.myshopify.com') {
            		carecartSpinnerJquery('body').append("<style type='text/css'>@media only screen and (max-width: 575px) {#wheelify-spin_a_sale_cc_store_front_module .wheelify-wheelContainer{margin-top: -110px !important ;}}</style>");    
	        }
		if (Shopify.shop == 'cat-the-fiddle-dev.myshopify.com') {
            		carecartSpinnerJquery('body').append("<style type='text/css'>#wheelify-spin_a_sale_cc_store_front_module .wheelText { fill: black !important;}</style>");    
	        }
		if (Shopify.shop == 'dr-nuzum.myshopify.com') {
            		carecartSpinnerJquery('body').append("<style type='text/css'>#wheelify-spin_a_sale_cc_store_front_module .checkbox{background: transparent;border: none;width: auto;height: auto;box-shadow: none;} .btn-submit-form{text-align: center;}</style>");    
	        }
		...
		if (Shopify.shop == 'kiiroo-amsterdam.myshopify.com') {
			carecartSpinnerJquery('body').append("<style type='text/css'>#wheelify-couponwheel_notice_content{margin-bottom: 47px; z-index: 0 !important;} </style>");
		}
		...
		if (Shopify.shop == 'shopbilletworkz.myshopify.com') {
	            carecartSpinnerJquery('head').append('<style type="text/css"> @media only screen and (min-width:576px) and (max-width:1180px) {#wheelify-spin_a_sale_cc_store_front_module.wheelify-wrapper-spinner.popupview {min-width: 555px!important;}}</style>');
	        }
                if (Shopify.shop == '814360-2.myshopify.com') {
                    carecartSpinnerJquery('body').append("<style type='text/css'>.wheelify-signupContainer .checkbox label {margin-bottom: 12px;} #wheelify-spin_a_sale_cc_store_front_module .checkbox{display: contents;} .wheelify-signupContainer .checkbox input {margin-top: 4px;} #wheelify-spin_a_sale_cc_store_front_module .btn-submit-form, #wheelify-spin_a_sale_cc_store_front_module .btn-submit-form-ok, #wheelify-spin_a_sale_cc_store_front_module .copy-button {text-align: center;}#wheelify-spin_a_sale_cc_store_front_module .wheelify-ContentRight {margin-top: 50px !important;} </style>");
                }
		if (Shopify.shop == 'zuber-tr.myshopify.com') {
		...
		if (Shopify.shop == 'wildsideco.myshopify.com') {
		 ...
		 if (Shopify.shop == '8889b6-4.myshopify.com') {
                        carecartSpinnerJquery('body').append("<style type='text/css'>@media only screen and (max-width: 575px){#wheelify-spin_a_sale_cc_store_front_module:not(.popupview) .wheelify-ContentRight {min-height: 450px !important;}}</style>");
                }
		...
		if (Shopify.shop == 'fc0a8f-b6.myshopify.com') {
                    carecartSpinnerJquery('body').append("<style type='text/css'>#wheelify-spin_a_sale_cc_store_front_module .checkbox{background: transparent;border: none;width: auto;height: auto;box-shadow: none;} .btn-submit-form{text-align: center;}</style>");
                }
		if (Shopify.shop == 'arcwell.myshopify.com') {
                    carecartSpinnerJquery('body').append("<style type='text/css'>svg g{stroke: transparent !important;}</style>");
                 }
		if (Shopify.shop == '5e44b6-2.myshopify.com') {
                    carecartSpinnerJquery('body').append("<style type='text/css'>#wheelify-spin_a_sale_cc_store_front_module .checkbox{background: transparent;border: none;width: auto;height: auto;box-shadow: none;} .btn-submit-form{text-align: center;}</style>");
                 }
                if (Shopify.shop == 'duma-nutrition-9b63.myshopify.com') {
             	    carecartSpinnerJquery('body').append("<style type='text/css'>[class*=' fa-']:before, [class^=fa-]:before{font-family: 'FontAwesome';}</style>");
                 }   
		...
		if (Shopify.shop == 'detectivebox.myshopify.com') {
		 ...
		 if (Shopify.shop == '9c6b3f.myshopify.com') {
                    carecartSpinnerJquery('head').append('<style type="text/css">@media only screen and (max-width:575px){#wheelify-spin_a_sale_cc_store_front_module.wheelify-wrapper-spinner{width: 86%;min-width: 86%;left: 50%;top: 50%;transform: translate(-50%, -50%);} #cc-spin-a-sale-consent-text{letter-spacing: normal;font-weight: normal; #wheelify-spin_a_sale_cc_store_front_module:not(.popupview).wheelify-content-spinner .wheelify-ContentRight{min-height: 524px!important;}#wheelify-spin_a_sale_cc_store_front_module.wheelify-wrapper-spinner{height: 96%;}}</style>');
                }
