...
scriptInjection("https://code.jquery.com/jquery-3.2.1.min.js", function () {
    ...
    let productID = 0;
    if (Shopify.shop == "dreamgift-1242.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
        productID = 8773044896080;
    }
    ...
    if (Shopify.shop == "d6b216-2.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };

        productID = 7125699493993;
    }
    if (Shopify.shop == "0f0ab2-e2.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };

        productID = 8469631435019;
    }
    ...
    if (Shopify.shop == "1d07b5-6e.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };

        productID = 8860141093197;
    }
    ...
    if (Shopify.shop == "386b82.myshopify.com") {
        ...
        productID = 8630318334286;
    }
    if (Shopify.shop == "52dd46-2.myshopify.com") {
        var meta = { "product": { "id": __st.rid } };
    ...
    let finalSelector = "";
     ...
     if (Shopify.shop == "1d07b5-6e.myshopify.com") {
        ...
        finalSelector = customSelctor[0];
        $jq321("head").append('<style type="text/css">.counter-text-carecartbysalespop-2020{background-color: #FFFFFF; !important; }</style>');
    }
    if (Shopify.shop == "0f0ab2-e2.myshopify.com") {
        customSelctor = $jq321(".gysHOIxPHU");
        finalSelector = customSelctor[0];
        $jq321("head").append('<style type="text/css">.visitor-counter-content-box-carecartbysalespop-2020{margin-top: -42px !important; }</style>');
    }
    if (Shopify.shop == "14a714-2.myshopify.com") {
    ...
    if (Shopify.shop == "sterone-7462.myshopify.com") {
       ...
       if (Shopify.shop == "3da54d.myshopify.com") {
        ...
        customSelctor = $jq321(".wc_store_average_section");
        finalSelector = customSelctor[0];
        ...
        if (isSmallScreen) {
            $jq321("head").append('<style type="text/css">.visitor-counter-content-box-carecartbysalespop-2020 {height: 45px !important;margin-top: -15px !important;}}</style>');
            customSelctor = $jq321(".wc_product_review_badge");
            finalSelector = customSelctor[0];    
        }
    }
